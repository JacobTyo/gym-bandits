...
for results in [results1]:
    ...
    all_rewards = results['reward']
    averaged_reward = all_rewards
    cumulated_average_reward = []
    cumulated_reward = 0

    all_expected_rewards = results['expected_reward']
    averaged_all_expected_rewards = all_expected_rewards
    cumulated_expected_rewards_counter = 0
    cumulated_expected_rewards = []

    all_optimal = results['optimal_mean']
    averaged_optimal = all_optimal
